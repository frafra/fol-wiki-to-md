Ranpwd è un utilissimo generatore di password da terminale, per chi avesse la necessità di cambiare spesso le password per l'acceso al pc, a siti web e soprattutto per l'Internet-banking.
